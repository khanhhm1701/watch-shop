...
const ProducsCard = ({ product }) => {
  ...
  return (
    <div onClick={handleDetails} className="product-card group relative">
      <div className="product-img-container w-full h-96 cursor-pointer overflow-hidden">
        <img
          src={product.image}
          alt="productImg"
      ...
      <div className="product-card-info w-full border-[1px] px-2 py-4">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="font-titleFont text-base font-bold m-0">
              {product.title.substring(0, 15)}
            </h2>
          </div>
          <div className="flex justify-end gap-2 relative overflow-hidden w-28 text-sm">
            <div className="flex gap-2 transform group-hover:translate-x-24 transition-transform duration-500">
              <p className="line-through text-gray-500 m-0">
                ${product.oldPrice}
              </p>
